...
public class Secp256k1CryptoCardAppet extends ECCryptoCardApplet {
    ...
    public static void install(byte[] bArray, short bOffset, byte bLength) {
        new Secp256k1CryptoCardAppet(bArray, bOffset, bLength);
    }

    public Secp256k1CryptoCardAppet(byte[] buffer, short offset, byte length) {
    ...
    private void setCurveParams(ECKey key) {
